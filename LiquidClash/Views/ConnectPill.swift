        ...
        ZStack {
            Circle()
                .fill(
                    RadialGradient(
                        colors: [
                            accentColor.opacity(isConnected || isConnecting ? 0.72 : 0.45),
                            accentColor.opacity(isConnected || isConnecting ? 0.48 : 0.28),
                            accentColor.opacity(isConnected || isConnecting ? 0.18 : 0.10),
                            .clear,
                        ],
                        center: .center,
                        startRadius: 12,
                ...
                .opacity(glowPhase ? (isConnected || isConnecting ? 0.9 : 0.65) : (isConnected || isConnecting ? 0.4 : 0.25))
