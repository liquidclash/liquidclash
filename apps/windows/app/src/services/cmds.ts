...
export interface MacosKillSwitchStatus {
  capabilityAvailable: boolean
  supported: boolean
  statusAvailable: boolean
  wanted: boolean
  live: boolean
  mode: 'disabled' | 'standard' | 'permanent'
}

export const getMacosKillSwitchStatus = async () => {
  return invoke<MacosKillSwitchStatus>('get_macos_kill_switch_status')
}
